...
void  printState(int n, int runLength, int nLines, int startRun1, int endRun1, 
		 int startRun2, int endRun2, int inLine1, int inLine2);
...
char *mergeSort(char *originalFile)
{
	...
	while (runLength < nLines) {
		...
		fprintf(stdout, "\n>>>>> Swap files, runLength:%d, inFile: %s , outFile: %s\n\n",
...
void mergePass(char *inFile, char *outFile, int runLength, int nLines)
{
	...
	for (;;) {
		...
		printState(n, runLength, nLines, startRun1, endRun1, 
				startRun2, endRun2, inLine1, inLine2 );
...
void  printState(int n, int runLength, int nLines, int startRun1, int endRun1, 
	...
	fprintf(stdout, " n:%d, runLength:%d, nLines:%d,\n startRun1:%d, endRun1:%d, startRun2:%d, endRun2:%d,\n inLine1:%d, inLine2:%d\n",
			 n, runLength, nLines, startRun1, endRun1, startRun2, endRun2, 
			 inLine1, inLine2) ;
